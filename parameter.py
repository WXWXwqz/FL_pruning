...
def build_parser():
    ...
    parser.add_argument('--iterate', action='store_true',
                        help='flag for iterate prune', default=False)
    ...
    parser.add_argument('--tozero-flag', action='store_true',
    ...
    parser.add_argument('--prune_method', type=str,
                        help='method for prune network', default='distance')
    ...
    parser.add_argument('--epoch', type=int,
                    help='number of epoch for training network', default=300)

    parser.add_argument('--update_param_epoch', type=int,
                        help='number of epoch to update params while prune network', default=30)

    parser.add_argument('--finetune_epoch', type=int,
                        help='number of epoch to finetune network', default=30)

    parser.add_argument('--ratio', type=float,
                    help='the value of ratio', default=0.3)

    parser.add_argument('--u', type=float,
                        help='the value of ratio', default=1)

    parser.add_argument('--flops-ratio', type=float,
                        help='the prune of flops ratio', default=0.4)
